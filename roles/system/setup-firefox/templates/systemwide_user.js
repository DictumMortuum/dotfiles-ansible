...
// Don't show 'know your rights' on the first run
defaultPref("browser.rights.3.shown",true);

// Disable the EME icon animation on tabs with DRM content
defaultPref("browser.eme.ui.firstContentShown",false);
...
//user_defaultPref("dom.serviceWorkers.enabled",				false);

// PREF: Disable Web Workers (disabled)
// https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Using_web_workers
// https://www.w3schools.com/html/html5_webworkers.asp
//user_defaultPref("dom.workers.enabled",					false);
...
//user_defaultPref("dom.webnotifications.enabled",			false);
...
defaultPref("geo.wifi.uri", "https://location.services.mozilla.com/v1/geolocate?key=%MOZILLA_API_KEY%");
...
defaultPref("dom.mozTCPSocket.enabled",				false);
...
//user_defaultPref("dom.storage.enabled",		false);
...
// user_defaultPref("dom.event.clipboardevents.enabled",			false);
...
// user_defaultPref("dom.allow_cut_copy", false);
...
//user_defaultPref("dom.indexedDB.enabled",		false);
...
//defaultPref("intl.locale.matchOS",				false);
...
defaultPref("browser.fixup.hide_user_pass", true);
...
// user_defaultPref("security.mixed_content.block_display_content",	true);
...
defaultPref("security.fileuri.strict_origin_policy",		true);
...
//user_defaultPref("svg.disabled", true);
...
defaultPref("network.protocol-handler.external.http",		false);
defaultPref("network.protocol-handler.external.https",		false);
defaultPref("network.protocol-handler.external.javascript",	false);
defaultPref("network.protocol-handler.external.moz-extension",	false);
defaultPref("network.protocol-handler.external.ftp",		false);
defaultPref("network.protocol-handler.external.file",		false);
defaultPref("network.protocol-handler.external.about",		false);
defaultPref("network.protocol-handler.external.chrome",		false);
defaultPref("network.protocol-handler.external.blob",		false);
defaultPref("network.protocol-handler.external.data",		false);
defaultPref("network.protocol-handler.expose-all",		false);
defaultPref("network.protocol-handler.expose.http",		true);
defaultPref("network.protocol-handler.expose.https",		true);
defaultPref("network.protocol-handler.expose.javascript",		true);
defaultPref("network.protocol-handler.expose.moz-extension",	true);
defaultPref("network.protocol-handler.expose.ftp",		true);
defaultPref("network.protocol-handler.expose.file",		true);
defaultPref("network.protocol-handler.expose.about",		true);
defaultPref("network.protocol-handler.expose.chrome",		true);
defaultPref("network.protocol-handler.expose.blob",		true);
defaultPref("network.protocol-handler.expose.data",		true);
...
//defaultPref("security.dialog_enable_delay",			1000);

// PREF: Require signatures
// https://wiki.mozilla.org/Addons/Extension_Signing
//user_defaultPref("xpinstall.signatures.required",		true);
...
//user_defaultPref("media.gmp-provider.enabled",		false);
...
defaultPref("devtools.debugger.force-local",			true);
...
//user_defaultPref("loop.enabled",		false);

// PREF: Disable Firefox Hello metrics collection
// https://groups.google.com/d/topic/mozilla.dev.platform/nyVkCx-_sFw/discussion
defaultPref("loop.logDomains",					false);
...
// CIS 2.1.1
//user_defaultPref("app.update.auto",					true);
...
//defaultPref("app.update.enabled",                 true);
...
// CIS 2.3.4
defaultPref("browser.safebrowsing.enabled",			true); // Firefox < 50
defaultPref("browser.safebrowsing.phishing.enabled",		true); // firefox >= 50
...
//user_defaultPref("network.http.keep-alive.timeout",			15);
...
//user_defaultPref("network.negotiate-auth.allow-insecure-ntlm-v1-https",		false);
...
defaultPref("security.csp.enable",				true);

// PREF: Enable Subresource Integrity
// https://developer.mozilla.org/en-US/docs/Web/Security/Subresource_Integrity
// https://wiki.mozilla.org/Security/Subresource_Integrity
defaultPref("security.sri.enable",				true);
...
//user_defaultPref("privacy.donottrackheader.enabled",		true);
...
// https://github.com/pyllyukko/user.js/issues/227
// user_defaultPref("network.http.referer.XOriginPolicy",		2);
...
//user_defaultPref("general.useragent.override",				"Mozilla/5.0 (Windows NT 6.1; rv:45.0) Gecko/20100101 Firefox/45.0");
//user_defaultPref("general.appname.override",				"Netscape");
//user_defaultPref("general.appversion.override",			"5.0 (Windows)");
//user_defaultPref("general.platform.override",				"Win32");
//user_defaultPref("general.oscpu.override",				"Windows NT 6.1");
...
//user_defaultPref("browser.privatebrowsing.autostart",			true);
...
//user_defaultPref("privacy.clearOnShutdown.cookies",			true);
...
//user_defaultPref("privacy.clearOnShutdown.passwords",			true);
...
//user_defaultPref("browser.cache.memory.enable",		false);
...
// user_defaultPref("signon.rememberSignons",				false);
...
//user_defaultPref("network.cookie.lifetimePolicy",			2);
...
//user_defaultPref("signon.storeWhenAutocompleteOff",			false);
...
//defaultPref("browser.newtabpage.directory.source",		"data:text/plain,{}");
...
//defaultPref("plugins.update.notifyUser",				true);
...
//defaultPref("browser.urlbar.autoFill.typed",			false);
...
//user_defaultPref("browser.urlbar.autocomplete.enabled",		false);
...
//defaultPref("security.password_lifetime",				1);

// PREF: Display a notification bar when websites offer data for offline use
// http://kb.mozillazine.org/Browser.offline-apps.notify
//defaultPref("browser.offline-apps.notify",			true);
...
//defaultPref("security.ssl.enable_ocsp_must_staple",		true);
...
//user_defaultPref("security.ssl.require_safe_negotiation",		true);
...
defaultPref("security.ssl3.rsa_null_sha",				false);
defaultPref("security.ssl3.rsa_null_md5",				false);
defaultPref("security.ssl3.ecdhe_rsa_null_sha",			false);
defaultPref("security.ssl3.ecdhe_ecdsa_null_sha",			false);
defaultPref("security.ssl3.ecdh_rsa_null_sha",			false);
defaultPref("security.ssl3.ecdh_ecdsa_null_sha",			false);

// PREF: Disable SEED cipher
// https://en.wikipedia.org/wiki/SEED
defaultPref("security.ssl3.rsa_seed_sha",				false);

// PREF: Disable 40/56/128-bit ciphers
// 40-bit ciphers
defaultPref("security.ssl3.rsa_rc4_40_md5",			false);
defaultPref("security.ssl3.rsa_rc2_40_md5",			false);
// 56-bit ciphers
defaultPref("security.ssl3.rsa_1024_rc4_56_sha",			false);
// 128-bit ciphers
defaultPref("security.ssl3.rsa_camellia_128_sha",			false);
defaultPref("security.ssl3.ecdhe_rsa_aes_128_sha",		false);
defaultPref("security.ssl3.ecdhe_ecdsa_aes_128_sha",		false);
defaultPref("security.ssl3.ecdh_rsa_aes_128_sha",			false);
defaultPref("security.ssl3.ecdh_ecdsa_aes_128_sha",		false);
defaultPref("security.ssl3.dhe_rsa_camellia_128_sha",		false);
...
defaultPref("security.ssl3.ecdh_ecdsa_rc4_128_sha",		false);
defaultPref("security.ssl3.ecdh_rsa_rc4_128_sha",			false);
defaultPref("security.ssl3.ecdhe_ecdsa_rc4_128_sha",		false);
defaultPref("security.ssl3.ecdhe_rsa_rc4_128_sha",		false);
defaultPref("security.ssl3.rsa_rc4_128_md5",			false);
...
defaultPref("security.ssl3.dhe_dss_des_ede3_sha",			false);
defaultPref("security.ssl3.dhe_rsa_des_ede3_sha",			false);
defaultPref("security.ssl3.ecdh_ecdsa_des_ede3_sha",		false);
defaultPref("security.ssl3.ecdh_rsa_des_ede3_sha",		false);
defaultPref("security.ssl3.ecdhe_ecdsa_des_ede3_sha",		false);
defaultPref("security.ssl3.ecdhe_rsa_des_ede3_sha",		false);
defaultPref("security.ssl3.rsa_des_ede3_sha",			false);
defaultPref("security.ssl3.rsa_fips_des_ede3_sha",		false);

// PREF: Disable ciphers with ECDH (non-ephemeral)
defaultPref("security.ssl3.ecdh_rsa_aes_256_sha",			false);
defaultPref("security.ssl3.ecdh_ecdsa_aes_256_sha",		false);

// PREF: Disable 256 bits ciphers without PFS
defaultPref("security.ssl3.rsa_camellia_256_sha",			false);

// PREF: Enable ciphers with ECDHE and key size > 128bits
defaultPref("security.ssl3.ecdhe_rsa_aes_256_sha",		true); // 0xc014
defaultPref("security.ssl3.ecdhe_ecdsa_aes_256_sha",		true); // 0xc00a

// PREF: Enable GCM ciphers (TLSv1.2 only)
// https://en.wikipedia.org/wiki/Galois/Counter_Mode
defaultPref("security.ssl3.ecdhe_ecdsa_aes_128_gcm_sha256",	true); // 0xc02b
defaultPref("security.ssl3.ecdhe_rsa_aes_128_gcm_sha256",		true); // 0xc02f
...
defaultPref("security.ssl3.ecdhe_ecdsa_chacha20_poly1305_sha256",	true);
defaultPref("security.ssl3.ecdhe_rsa_chacha20_poly1305_sha256",	true);

// PREF: Disable ciphers susceptible to the logjam attack
// https://weakdh.org/
defaultPref("security.ssl3.dhe_rsa_camellia_256_sha",		false);
defaultPref("security.ssl3.dhe_rsa_aes_256_sha",			false);

// PREF: Disable ciphers with DSA (max 1024 bits)
defaultPref("security.ssl3.dhe_dss_aes_128_sha",			false);
defaultPref("security.ssl3.dhe_dss_aes_256_sha",			false);
defaultPref("security.ssl3.dhe_dss_camellia_128_sha",		false);
defaultPref("security.ssl3.dhe_dss_camellia_256_sha",		false);

// PREF: Fallbacks due compatibility reasons
defaultPref("security.ssl3.rsa_aes_256_sha",			true); // 0x35
defaultPref("security.ssl3.rsa_aes_128_sha",			true); // 0x2f
